...
set shortmess=aoO
badd +0 PasswordManager/settings.py
badd +0 PasswordManager/urls.py
badd +0 manager/views.py
badd +0 manager/models.py
badd +0 manager/urls.py
badd +0 generator/views.py
argglobal
%argdel
$argadd .
set stal=2
